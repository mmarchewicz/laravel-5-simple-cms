...
use App\Managers\TranslationManager\Manager;

class TranslationsController extends BaseController
{
    /** @var \App\Managers\TranslationManager\Manager  */
    protected $manager;
    ...
    public function getIndex($group = null)
    {
        ...
        foreach($allTranslations as $translation){
         ...
         return view('admin.translations')
            ...
            ->with('editUrl', action('\App\Http\Controllers\Admin\TranslationsController@postEdit', [$group]))
    ...
    public function postAddGroup(Request $request)
    {
        ...
        if ($group)
        {
            return redirect()->action('\App\Http\Controllers\Admin\TranslationsController@getView',$group);
        }
        else
        {
            return redirect()->back();
